...
import com.web.dto.mapper.group.GroupMapper;
...
import com.web.repositories.group.GroupSpecs;
...
import com.web.utils.slug.Slugger;
...
public class GroupServiceImp implements GroupService {
    ...
    @Override
    public Page<GroupCardResponse> getJoinedGroups(Long userId, GroupFilter filter, Pageable pageable) {
    ...
    @Override
    public Page<GroupCardResponse> getOwnedGroups(Long userId, GroupFilter filter, Pageable pageable) {
    ...
    @Override
    public Page<GroupCardResponse> getDiscoverGroups(Long userId, GroupFilter filter, Pageable pageable) {
