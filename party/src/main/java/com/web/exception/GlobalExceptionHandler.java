...
import com.web.dto.response.ApiError;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError<Void>> handleMaxSizeException(MaxUploadSizeExceededException exc, HttpServletRequest request) {
        return ResponseEntity.status(HttpStatus.PAYLOAD_TOO_LARGE)
                .body(ApiError.<Void>builder()
                        .code("FILE_TOO_LARGE")
                        .message("File quá lớn! Vui lòng tải file dưới 50MB.")
