        ...
        <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/10">
            <div className="space-y-8 p-6 max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    <Card
                        className="lg:col-span-2 overflow-hidden relative bg-gradient-to-br from-primary/5 via-background to-primary/10">
                        <div
                            ...
                            <div className="flex items-center gap-4 mb-4">
                                ...
                                <div>
                                    <CardTitle className="text-2xl mb-1">
                                        Chào mừng trở
                                        lại, {user?.displayName || user?.email?.split('@')[0] || 'Học viên'}! 👋
                                    </CardTitle>
                        ...
                        <CardContent className="relative z-10">
                            ...
                            <div className="space-y-2 mb-4">
                                <div className="flex gap-1">
                                    {[...Array(7)].map((_, i) => (
                                        <div key={i}
                                             className="h-2 flex-1 rounded-full bg-gradient-to-r from-success to-success/80"/>
                                    ))}
                                </div>
                        ...
                        <Card key={i} className="hover:shadow-md transition-all duration-300 group">
                            <CardContent className="p-4">
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    <TrendingUp
                                        className="h-3 w-3 text-muted-foreground opacity-60 group-hover:opacity-100 transition-opacity"/>
                                </div>
